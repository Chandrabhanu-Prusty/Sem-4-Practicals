...
|---|---|
| [AI/A_star.py](AI/A_star.py) | A* Search |
| [AI/Alpha_Beta.py](AI/Alpha_Beta.py) | Alpha-Beta Pruning |
| [AI/FamilyTree.py](AI/FamilyTree.py) | Family Tree reasoning |
| [AI/FOL.py](AI/FOL.py) | First Order Logic |
| [AI/GreedyBFS.py](AI/GreedyBFS.py) | Greedy Best-First Search |
| [AI/Hanoi.py](AI/Hanoi.py) | Tower of Hanoi |
| [AI/hill_climbing.py](AI/hill_climbing.py) | Hill Climbing |
| [AI/Minimax.py](AI/Minimax.py) | Minimax Algorithm |
| [AI/Searching_techiques.py](AI/Searching_techiques.py) | Search Techniques |
| [AI/WaterJug.py](AI/WaterJug.py) | Water Jug Problem |
| [AI/A start graph.png](AI/A%20start%20graph.png) | A* graph reference image |

## DAA Practicals (Java)

| File | Topic / Experiment |
|---|---|
| [DAA/Exp1_Insertion_Sort.java](DAA/Exp1_Insertion_Sort.java) | Insertion Sort |
| [DAA/Exp1_Selection_Sort.java](DAA/Exp1_Selection_Sort.java) | Selection Sort |
| [DAA/Exp2_MergeSort.java](DAA/Exp2_MergeSort.java) | Merge Sort |
| [DAA/Exp2_QuickSort.java](DAA/Exp2_QuickSort.java) | Quick Sort |
| [DAA/Exp3_Fractional_Knacpsack.java](DAA/Exp3_Fractional_Knacpsack.java) | Fractional Knapsack |
| [DAA/Exp4_JobSequencing.java](DAA/Exp4_JobSequencing.java) | Job Sequencing |
| [DAA/Exp5_Kruskal.java](DAA/Exp5_Kruskal.java) | Kruskal MST |
| [DAA/Exp5_Prims.java](DAA/Exp5_Prims.java) | Prim MST |
| [DAA/Exp6_Knapsack01.java](DAA/Exp6_Knapsack01.java) | 0/1 Knapsack |
| [DAA/Exp7_BinarySearch.java](DAA/Exp7_BinarySearch.java) | Binary Search |
...
- File names are kept exactly as they currently exist in the repository.
- You can add new practicals directly under the respective subject folder to keep this mapping organized.
